...
public class ProductListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*setListAdapter(new ArrayAdapter<Product>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, (new Repository()).getProducts()));*/
		setListAdapter(new ProductsAdapter(getActivity(), (new Repository()).getProducts()));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(((Product)listView.getAdapter().getItem(position)).getId().toString());
	}
